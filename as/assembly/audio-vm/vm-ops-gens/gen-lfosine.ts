...
export function initGenPools_Lfosine(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Lfosine_default_bar_scalar_offset_scalar_trig_scalar(), 77, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfosine_default_bar_scalar_offset_scalar_trig_audio(), 78, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfosine_default_bar_scalar_offset_audio_trig_scalar(), 79, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfosine_default_bar_scalar_offset_audio_trig_audio(), 80, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfosine_default_bar_audio_offset_scalar_trig_scalar(), 81, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfosine_default_bar_audio_offset_scalar_trig_audio(), 82, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfosine_default_bar_audio_offset_audio_trig_scalar(), 83, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfosine_default_bar_audio_offset_audio_trig_audio(), 84, 4, vm.genPoolManager, (dst: Object, src: Object) => {
