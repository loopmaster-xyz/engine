...
export function initGenPools_Slew(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Slew_default_up_scalar_down_scalar_exp_scalar(), 599, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Slew_default_up_scalar_down_scalar_exp_audio(), 600, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Slew_default_up_scalar_down_audio_exp_scalar(), 601, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Slew_default_up_scalar_down_audio_exp_audio(), 602, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Slew_default_up_audio_down_scalar_exp_scalar(), 603, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Slew_default_up_audio_down_scalar_exp_audio(), 604, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Slew_default_up_audio_down_audio_exp_scalar(), 605, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Slew_default_up_audio_down_audio_exp_audio(), 606, 3, vm.genPoolManager, (dst: Object, src: Object) => {
