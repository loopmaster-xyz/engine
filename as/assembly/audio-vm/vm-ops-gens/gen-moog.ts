...
export function initGenPools_Moog(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Moog_lpm_cutoff_scalar_q_scalar(), 587, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Moog_lpm_cutoff_audio_q_scalar(), 588, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Moog_hpm_cutoff_scalar_q_scalar(), 589, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Moog_hpm_cutoff_audio_q_scalar(), 590, 2, vm.genPoolManager, (dst: Object, src: Object) => {
