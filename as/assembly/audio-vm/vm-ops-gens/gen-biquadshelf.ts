...
export function initGenPools_Biquadshelf(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Biquadshelf_ls_cutoff_scalar_q_scalar_gain_scalar(), 555, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_ls_cutoff_scalar_q_scalar_gain_audio(), 556, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_ls_cutoff_scalar_q_audio_gain_scalar(), 557, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_ls_cutoff_scalar_q_audio_gain_audio(), 558, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_ls_cutoff_audio_q_scalar_gain_scalar(), 559, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_ls_cutoff_audio_q_scalar_gain_audio(), 560, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_ls_cutoff_audio_q_audio_gain_scalar(), 561, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_ls_cutoff_audio_q_audio_gain_audio(), 562, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_hs_cutoff_scalar_q_scalar_gain_scalar(), 563, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_hs_cutoff_scalar_q_scalar_gain_audio(), 564, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_hs_cutoff_scalar_q_audio_gain_scalar(), 565, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_hs_cutoff_scalar_q_audio_gain_audio(), 566, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_hs_cutoff_audio_q_scalar_gain_scalar(), 567, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_hs_cutoff_audio_q_scalar_gain_audio(), 568, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_hs_cutoff_audio_q_audio_gain_scalar(), 569, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_hs_cutoff_audio_q_audio_gain_audio(), 570, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_peak_cutoff_scalar_q_scalar_gain_scalar(), 571, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_peak_cutoff_scalar_q_scalar_gain_audio(), 572, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_peak_cutoff_scalar_q_audio_gain_scalar(), 573, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_peak_cutoff_scalar_q_audio_gain_audio(), 574, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_peak_cutoff_audio_q_scalar_gain_scalar(), 575, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_peak_cutoff_audio_q_scalar_gain_audio(), 576, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_peak_cutoff_audio_q_audio_gain_scalar(), 577, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquadshelf_peak_cutoff_audio_q_audio_gain_audio(), 578, 3, vm.genPoolManager, (dst: Object, src: Object) => {
    ...
    if (inputArrId > 0 && inputArrId <= u32(vm.arrays.length)) {
      ...
      if (inputArrLen >= 2) {
        ...
        switch (modeMask) {
          ...
          case 4: {
            {
              const slot: GenSlot = vm.genPools[556].get()
              genOpHelpers.writeCallStackMetaToSlot(vm, slot)
              const procLen: i32 = genOpHelpers.alignedProcLength(params.bufferLength)
              const inputSrcResult = genOpHelpers.taggedToInputBuffer(vm, inputLeftResolved, procLen)
              const inputSrcPtr: usize = inputSrcResult.ptr
          ...
          case 2: {
            {
              const slot: GenSlot = vm.genPools[557].get()
              genOpHelpers.writeCallStackMetaToSlot(vm, slot)
              const procLen: i32 = genOpHelpers.alignedProcLength(params.bufferLength)
              const inputSrcResult = genOpHelpers.taggedToInputBuffer(vm, inputLeftResolved, procLen)
              const inputSrcPtr: usize = inputSrcResult.ptr
          ...
          case 6: {
            {
              const slot: GenSlot = vm.genPools[558].get()
              genOpHelpers.writeCallStackMetaToSlot(vm, slot)
              const procLen: i32 = genOpHelpers.alignedProcLength(params.bufferLength)
              const inputSrcResult = genOpHelpers.taggedToInputBuffer(vm, inputLeftResolved, procLen)
              const inputSrcPtr: usize = inputSrcResult.ptr
