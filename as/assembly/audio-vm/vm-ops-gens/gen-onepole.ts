...
export function initGenPools_Onepole(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Onepole_lp1_cutoff_scalar(), 199, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Onepole_lp1_cutoff_audio(), 200, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Onepole_hp1_cutoff_scalar(), 201, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Onepole_hp1_cutoff_audio(), 202, 1, vm.genPoolManager, (dst: Object, src: Object) => {
