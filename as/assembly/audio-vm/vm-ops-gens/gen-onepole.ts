...
import { Onepole_hp1_cutoff_audio, Onepole_hp1_cutoff_scalar, Onepole_lp1_cutoff_audio, Onepole_lp1_cutoff_scalar } from '../../gen/onepole'
...
export function initGenPools_Onepole(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Onepole_lp1_cutoff_scalar(), 203, 1, vm.genPoolManager, (dst: Object, src: Object) => {
    changetype<Onepole_lp1_cutoff_scalar>(dst).copyFrom(changetype<Onepole_lp1_cutoff_scalar>(src))
  }, (dst: Object) => { changetype<Onepole_lp1_cutoff_scalar>(dst).reset() }))
  vm.genPools.push(new GenPool(() => new Onepole_lp1_cutoff_audio(), 204, 1, vm.genPoolManager, (dst: Object, src: Object) => {
    changetype<Onepole_lp1_cutoff_audio>(dst).copyFrom(changetype<Onepole_lp1_cutoff_audio>(src))
  }, (dst: Object) => { changetype<Onepole_lp1_cutoff_audio>(dst).reset() }))
  vm.genPools.push(new GenPool(() => new Onepole_hp1_cutoff_scalar(), 205, 1, vm.genPoolManager, (dst: Object, src: Object) => {
    changetype<Onepole_hp1_cutoff_scalar>(dst).copyFrom(changetype<Onepole_hp1_cutoff_scalar>(src))
  }, (dst: Object) => { changetype<Onepole_hp1_cutoff_scalar>(dst).reset() }))
  vm.genPools.push(new GenPool(() => new Onepole_hp1_cutoff_audio(), 206, 1, vm.genPoolManager, (dst: Object, src: Object) => {
    changetype<Onepole_hp1_cutoff_audio>(dst).copyFrom(changetype<Onepole_hp1_cutoff_audio>(src))
  }, (dst: Object) => { changetype<Onepole_hp1_cutoff_audio>(dst).reset() }))
}

export function handleGenOp_Onepole(vm: VmState, op: AudioVmOp, pc: i32, opsPtr: usize, params: RunParams): i32 {
  switch (op) {
          ...
          case 0: {
            {
              ...
              const instance: Onepole_lp1_cutoff_scalar = changetype<Onepole_lp1_cutoff_scalar>(slot.instance)
              slot.history.write(params.sampleCount, vm.paramScratch)
              instance.process(params.bufferLength, params.sampleCount, params.sampleRate, params.nyquist, params.piOverNyquist, vm.currentBpm, vm.co, vm.samplesPerBeat, vm.samplesPerBar, inputPtr, outputPtr, cutoffValue)
          ...
          case 1: {
            {
              ...
              output = vm.arena.get(procLen)
              const outputPtr: usize = output.dataStart
              const instance: Onepole_lp1_cutoff_audio = changetype<Onepole_lp1_cutoff_audio>(slot.instance)
              const cutoffAudioResult = genOpHelpers.taggedToAudioParamBuffer(vm, cutoffTagged, procLen)
              slot.history.write(params.sampleCount, vm.paramScratch)
              instance.process(params.bufferLength, params.sampleCount, params.sampleRate, params.nyquist, params.piOverNyquist, vm.currentBpm, vm.co, vm.samplesPerBeat, vm.samplesPerBar, inputPtr, outputPtr, cutoffAudioResult.ptr)
              genOpHelpers.writeOutputToHistoryRing(slot.history, outputPtr, params.bufferLength)
              genOpHelpers.releaseTaggedInputBuf(vm, inputSrcBuf)
          ...
          case 0: {
            {
              ...
              output = vm.arena.get(procLen)
              const outputPtr: usize = output.dataStart
              const instance: Onepole_hp1_cutoff_scalar = changetype<Onepole_hp1_cutoff_scalar>(slot.instance)
              slot.history.write(params.sampleCount, vm.paramScratch)
              instance.process(params.bufferLength, params.sampleCount, params.sampleRate, params.nyquist, params.piOverNyquist, vm.currentBpm, vm.co, vm.samplesPerBeat, vm.samplesPerBar, inputPtr, outputPtr, cutoffValue)
              genOpHelpers.writeOutputToHistoryRing(slot.history, outputPtr, params.bufferLength)
              genOpHelpers.releaseTaggedInputBuf(vm, inputSrcBuf)
          ...
          case 1: {
            {
              ...
              output = vm.arena.get(procLen)
              const outputPtr: usize = output.dataStart
              const instance: Onepole_hp1_cutoff_audio = changetype<Onepole_hp1_cutoff_audio>(slot.instance)
              const cutoffAudioResult = genOpHelpers.taggedToAudioParamBuffer(vm, cutoffTagged, procLen)
              slot.history.write(params.sampleCount, vm.paramScratch)
              instance.process(params.bufferLength, params.sampleCount, params.sampleRate, params.nyquist, params.piOverNyquist, vm.currentBpm, vm.co, vm.samplesPerBeat, vm.samplesPerBar, inputPtr, outputPtr, cutoffAudioResult.ptr)
              genOpHelpers.writeOutputToHistoryRing(slot.history, outputPtr, params.bufferLength)
