...
export function initGenPools_Onepole(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Onepole_lp1_cutoff_scalar(), 273, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Onepole_lp1_cutoff_audio(), 274, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Onepole_hp1_cutoff_scalar(), 275, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Onepole_hp1_cutoff_audio(), 276, 1, vm.genPoolManager, (dst: Object, src: Object) => {
