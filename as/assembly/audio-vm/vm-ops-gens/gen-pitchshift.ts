...
export function initGenPools_Pitchshift(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Pitchshift_default_ratio_scalar(), 386, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Pitchshift_default_ratio_audio(), 387, 1, vm.genPoolManager, (dst: Object, src: Object) => {
