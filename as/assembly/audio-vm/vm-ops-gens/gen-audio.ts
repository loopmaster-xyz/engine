...
import { Audio_default_ } from '../../gen/audio'
...
export function handleGenOp_Audio(vm: VmState, op: AudioVmOp, pc: i32, opsPtr: usize, params: RunParams): i32 {
  switch (op) {
          ...
          case 0: {
            {
              ...
              const instance: Audio_default_ = changetype<Audio_default_>(slot.instance)
