...
import { Analyser_default_ } from '../../gen/analyser'
...
export function initGenPools_Analyser(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Analyser_default_(), 441, 0, vm.genPoolManager, (dst: Object, src: Object) => {
...
export function handleGenOp_Analyser(vm: VmState, op: AudioVmOp, pc: i32, opsPtr: usize, params: RunParams): i32 {
  switch (op) {
          ...
          case 0: {
            {
              ...
              const instance: Analyser_default_ = changetype<Analyser_default_>(slot.instance)
