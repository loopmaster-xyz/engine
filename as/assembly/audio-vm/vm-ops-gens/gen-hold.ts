...
import { Hold_default_ } from '../../gen/hold'
...
export function initGenPools_Hold(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Hold_default_(), 285, 0, vm.genPoolManager, (dst: Object, src: Object) => {
    changetype<Hold_default_>(dst).copyFrom(changetype<Hold_default_>(src))
  }, (dst: Object) => { changetype<Hold_default_>(dst).reset() }))
}

export function handleGenOp_Hold(vm: VmState, op: AudioVmOp, pc: i32, opsPtr: usize, params: RunParams): i32 {
  switch (op) {
          ...
          case 0: {
            {
              ...
              const instance: Hold_default_ = changetype<Hold_default_>(slot.instance)
