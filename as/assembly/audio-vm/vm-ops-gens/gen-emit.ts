...
export function initGenPools_Emit(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Emit_default_value_scalar(), 358, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Emit_default_value_audio(), 359, 1, vm.genPoolManager, (dst: Object, src: Object) => {
