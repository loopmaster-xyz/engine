...
export function initGenPools_Lfotri(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Lfotri_default_bar_scalar_offset_scalar_trig_scalar(), 437, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfotri_default_bar_scalar_offset_scalar_trig_audio(), 438, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfotri_default_bar_scalar_offset_audio_trig_scalar(), 439, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfotri_default_bar_scalar_offset_audio_trig_audio(), 440, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfotri_default_bar_audio_offset_scalar_trig_scalar(), 441, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfotri_default_bar_audio_offset_scalar_trig_audio(), 442, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfotri_default_bar_audio_offset_audio_trig_scalar(), 443, 4, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Lfotri_default_bar_audio_offset_audio_trig_audio(), 444, 4, vm.genPoolManager, (dst: Object, src: Object) => {
