...
export function initGenPools_Sah(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Sah_default_trig_scalar(), 534, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Sah_default_trig_audio(), 535, 1, vm.genPoolManager, (dst: Object, src: Object) => {
          ...
          case 1: {
            {
              ...
              slot.history.write(params.sampleCount, vm.paramScratch)
              instance.process(params.bufferLength, params.sampleCount, params.sampleRate, params.nyquist, params.piOverNyquist, vm.currentBpm, vm.co, vm.samplesPerBeat, vm.samplesPerBar, inputPtr, outputPtr, trigAudioPtr)
              genOpHelpers.writeOutputToHistoryRing(slot.history, outputPtr, params.bufferLength)
              vm.endTempAudioScope(tempScopeMark)
              outputL = output
            }
