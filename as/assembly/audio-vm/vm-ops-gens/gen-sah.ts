...
export function initGenPools_Sah(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Sah_default_trig_scalar(), 462, 1, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Sah_default_trig_audio(), 463, 1, vm.genPoolManager, (dst: Object, src: Object) => {
