...
export function initGenPools_Biquad(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Biquad_lp_cutoff_scalar_q_scalar(), 438, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_lp_cutoff_scalar_q_audio(), 439, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_lp_cutoff_audio_q_scalar(), 440, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_lp_cutoff_audio_q_audio(), 441, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_hp_cutoff_scalar_q_scalar(), 442, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_hp_cutoff_scalar_q_audio(), 443, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_hp_cutoff_audio_q_scalar(), 444, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_hp_cutoff_audio_q_audio(), 445, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_bp_cutoff_scalar_q_scalar(), 446, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_bp_cutoff_scalar_q_audio(), 447, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_bp_cutoff_audio_q_scalar(), 448, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_bp_cutoff_audio_q_audio(), 449, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_bs_cutoff_scalar_q_scalar(), 450, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_bs_cutoff_scalar_q_audio(), 451, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_bs_cutoff_audio_q_scalar(), 452, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_bs_cutoff_audio_q_audio(), 453, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_ap_cutoff_scalar_q_scalar(), 454, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_ap_cutoff_scalar_q_audio(), 455, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_ap_cutoff_audio_q_scalar(), 456, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Biquad_ap_cutoff_audio_q_audio(), 457, 2, vm.genPoolManager, (dst: Object, src: Object) => {
    ...
    if (inputArrId > 0 && inputArrId <= u32(vm.arrays.length)) {
      ...
      if (inputArrLen >= 2) {
        ...
        switch (modeMask) {
          ...
          case 3: {
            {
              const slot: GenSlot = vm.genPools[441].get()
              genOpHelpers.writeCallStackMetaToSlot(vm, slot)
              const procLen: i32 = genOpHelpers.alignedProcLength(params.bufferLength)
              const inputSrcResult = genOpHelpers.taggedToInputBuffer(vm, inputLeftResolved, procLen)
              const inputSrcPtr: usize = inputSrcResult.ptr
    ...
    if (inputArrId > 0 && inputArrId <= u32(vm.arrays.length)) {
      ...
      if (inputArrLen >= 2) {
        ...
        switch (modeMask) {
          case 0: {
            {
              const slot: GenSlot = vm.genPools[442].get()
              genOpHelpers.writeCallStackMetaToSlot(vm, slot)
              const procLen: i32 = genOpHelpers.alignedProcLength(params.bufferLength)
              const inputSrcResult = genOpHelpers.taggedToInputBuffer(vm, inputLeftResolved, procLen)
              const inputSrcPtr: usize = inputSrcResult.ptr
          ...
          case 2: {
            {
              const slot: GenSlot = vm.genPools[443].get()
              genOpHelpers.writeCallStackMetaToSlot(vm, slot)
              const procLen: i32 = genOpHelpers.alignedProcLength(params.bufferLength)
              const inputSrcResult = genOpHelpers.taggedToInputBuffer(vm, inputLeftResolved, procLen)
              const inputSrcPtr: usize = inputSrcResult.ptr
          ...
          case 1: {
            {
              const slot: GenSlot = vm.genPools[444].get()
              genOpHelpers.writeCallStackMetaToSlot(vm, slot)
              const procLen: i32 = genOpHelpers.alignedProcLength(params.bufferLength)
              const inputSrcResult = genOpHelpers.taggedToInputBuffer(vm, inputLeftResolved, procLen)
              const inputSrcPtr: usize = inputSrcResult.ptr
