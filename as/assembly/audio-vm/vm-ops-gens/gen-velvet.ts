...
export function initGenPools_Velvet(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Velvet_default_room_scalar_damping_scalar_decay_scalar(), 536, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_scalar_damping_scalar_decay_audio(), 537, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_scalar_damping_audio_decay_scalar(), 538, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_scalar_damping_audio_decay_audio(), 539, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_audio_damping_scalar_decay_scalar(), 540, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_audio_damping_scalar_decay_audio(), 541, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_audio_damping_audio_decay_scalar(), 542, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_audio_damping_audio_decay_audio(), 543, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_scalar_damping_scalar_decay_scalar_stereo(), 544, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_scalar_damping_scalar_decay_audio_stereo(), 545, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_scalar_damping_audio_decay_scalar_stereo(), 546, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_scalar_damping_audio_decay_audio_stereo(), 547, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_audio_damping_scalar_decay_scalar_stereo(), 548, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_audio_damping_scalar_decay_audio_stereo(), 549, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_audio_damping_audio_decay_scalar_stereo(), 550, 3, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Velvet_default_room_audio_damping_audio_decay_audio_stereo(), 551, 3, vm.genPoolManager, (dst: Object, src: Object) => {
