...
export function initGenPools_Pink(vm: VmState): void {
  vm.genPools.push(new GenPool(() => new Pink_default_seed_scalar_trig_scalar(), 516, 2, vm.genPoolManager, (dst: Object, src: Object) => {
  ...
  vm.genPools.push(new GenPool(() => new Pink_default_seed_scalar_trig_audio(), 517, 2, vm.genPoolManager, (dst: Object, src: Object) => {
