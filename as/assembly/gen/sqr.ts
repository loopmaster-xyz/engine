...
export class Sqr_default_hz_scalar_offset_scalar_trig_scalar {
  static readonly defaultInstance: Sqr_default_hz_scalar_offset_scalar_trig_scalar = new Sqr_default_hz_scalar_offset_scalar_trig_scalar()
  ...
  reset(): void {
    this.copyFrom(Sqr_default_hz_scalar_offset_scalar_trig_scalar.defaultInstance)
  }

  copyFrom(src: Sqr_default_hz_scalar_offset_scalar_trig_scalar): void {
...
export class Sqr_default_hz_scalar_offset_scalar_trig_audio {
  static readonly defaultInstance: Sqr_default_hz_scalar_offset_scalar_trig_audio = new Sqr_default_hz_scalar_offset_scalar_trig_audio()
  ...
  reset(): void {
    this.copyFrom(Sqr_default_hz_scalar_offset_scalar_trig_audio.defaultInstance)
  }

  copyFrom(src: Sqr_default_hz_scalar_offset_scalar_trig_audio): void {
    this.angle = src.angle
    this.lastHz = src.lastHz
    this.lastSampleRate = src.lastSampleRate
    this.prevTrig = src.prevTrig
...
export class Sqr_default_hz_scalar_offset_audio_trig_scalar {
  static readonly defaultInstance: Sqr_default_hz_scalar_offset_audio_trig_scalar = new Sqr_default_hz_scalar_offset_audio_trig_scalar()
  ...
  reset(): void {
    this.copyFrom(Sqr_default_hz_scalar_offset_audio_trig_scalar.defaultInstance)
  }

  copyFrom(src: Sqr_default_hz_scalar_offset_audio_trig_scalar): void {
    this.angle = src.angle
    this.lastHz = src.lastHz
    this.lastTrig = src.lastTrig
    this.lastSampleRate = src.lastSampleRate
...
export class Sqr_default_hz_scalar_offset_audio_trig_audio {
  static readonly defaultInstance: Sqr_default_hz_scalar_offset_audio_trig_audio = new Sqr_default_hz_scalar_offset_audio_trig_audio()
  ...
  reset(): void {
    this.copyFrom(Sqr_default_hz_scalar_offset_audio_trig_audio.defaultInstance)
  }

  copyFrom(src: Sqr_default_hz_scalar_offset_audio_trig_audio): void {
    this.angle = src.angle
    this.lastHz = src.lastHz
    this.lastSampleRate = src.lastSampleRate
    this.prevTrig = src.prevTrig
...
export class Sqr_default_hz_audio_offset_scalar_trig_scalar {
  static readonly defaultInstance: Sqr_default_hz_audio_offset_scalar_trig_scalar = new Sqr_default_hz_audio_offset_scalar_trig_scalar()
  ...
  reset(): void {
    this.copyFrom(Sqr_default_hz_audio_offset_scalar_trig_scalar.defaultInstance)
  }

  copyFrom(src: Sqr_default_hz_audio_offset_scalar_trig_scalar): void {
    this.angle = src.angle
    this.lastTrig = src.lastTrig
    this.prevTrig = src.prevTrig
    this.phaseInc = src.phaseInc
...
export class Sqr_default_hz_audio_offset_scalar_trig_audio {
  static readonly defaultInstance: Sqr_default_hz_audio_offset_scalar_trig_audio = new Sqr_default_hz_audio_offset_scalar_trig_audio()
  ...
  reset(): void {
    this.copyFrom(Sqr_default_hz_audio_offset_scalar_trig_audio.defaultInstance)
  }

  copyFrom(src: Sqr_default_hz_audio_offset_scalar_trig_audio): void {
    this.angle = src.angle
    this.prevTrig = src.prevTrig
    this.phaseInc = src.phaseInc
  }
...
export class Sqr_default_hz_audio_offset_audio_trig_scalar {
  static readonly defaultInstance: Sqr_default_hz_audio_offset_audio_trig_scalar = new Sqr_default_hz_audio_offset_audio_trig_scalar()
  ...
  reset(): void {
    this.copyFrom(Sqr_default_hz_audio_offset_audio_trig_scalar.defaultInstance)
  }

  copyFrom(src: Sqr_default_hz_audio_offset_audio_trig_scalar): void {
    this.angle = src.angle
    this.lastTrig = src.lastTrig
    this.prevTrig = src.prevTrig
    this.phaseInc = src.phaseInc
...
export class Sqr_default_hz_audio_offset_audio_trig_audio {
  static readonly defaultInstance: Sqr_default_hz_audio_offset_audio_trig_audio = new Sqr_default_hz_audio_offset_audio_trig_audio()
  ...
  reset(): void {
    this.copyFrom(Sqr_default_hz_audio_offset_audio_trig_audio.defaultInstance)
  }

  copyFrom(src: Sqr_default_hz_audio_offset_audio_trig_audio): void {
    this.angle = src.angle
    this.lastSampleRate = src.lastSampleRate
    this.prevTrig = src.prevTrig
    this.phaseInc = src.phaseInc
