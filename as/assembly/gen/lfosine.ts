...
export class Lfosine_default_bar_scalar_offset_scalar_trig_scalar {
  static readonly defaultInstance: Lfosine_default_bar_scalar_offset_scalar_trig_scalar = new Lfosine_default_bar_scalar_offset_scalar_trig_scalar()
  ...
  reset(): void {
    this.copyFrom(Lfosine_default_bar_scalar_offset_scalar_trig_scalar.defaultInstance)
  }

  copyFrom(src: Lfosine_default_bar_scalar_offset_scalar_trig_scalar): void {
...
export class Lfosine_default_bar_scalar_offset_scalar_trig_audio {
  static readonly defaultInstance: Lfosine_default_bar_scalar_offset_scalar_trig_audio = new Lfosine_default_bar_scalar_offset_scalar_trig_audio()
  ...
  reset(): void {
    this.copyFrom(Lfosine_default_bar_scalar_offset_scalar_trig_audio.defaultInstance)
  }

  copyFrom(src: Lfosine_default_bar_scalar_offset_scalar_trig_audio): void {
    this.phase = src.phase
    this.lastBar = src.lastBar
    this.lastSamplesPerBar = src.lastSamplesPerBar
    this.prevTrig = src.prevTrig
...
export class Lfosine_default_bar_scalar_offset_audio_trig_scalar {
  static readonly defaultInstance: Lfosine_default_bar_scalar_offset_audio_trig_scalar = new Lfosine_default_bar_scalar_offset_audio_trig_scalar()
  ...
  reset(): void {
    this.copyFrom(Lfosine_default_bar_scalar_offset_audio_trig_scalar.defaultInstance)
  }

  copyFrom(src: Lfosine_default_bar_scalar_offset_audio_trig_scalar): void {
    this.phase = src.phase
    this.lastBar = src.lastBar
    this.lastTrig = src.lastTrig
    this.lastSamplesPerBeat = src.lastSamplesPerBeat
...
export class Lfosine_default_bar_scalar_offset_audio_trig_audio {
  static readonly defaultInstance: Lfosine_default_bar_scalar_offset_audio_trig_audio = new Lfosine_default_bar_scalar_offset_audio_trig_audio()
  ...
  reset(): void {
    this.copyFrom(Lfosine_default_bar_scalar_offset_audio_trig_audio.defaultInstance)
  }

  copyFrom(src: Lfosine_default_bar_scalar_offset_audio_trig_audio): void {
    this.phase = src.phase
    this.lastBar = src.lastBar
    this.lastSamplesPerBar = src.lastSamplesPerBar
    this.prevTrig = src.prevTrig
...
export class Lfosine_default_bar_audio_offset_scalar_trig_scalar {
  static readonly defaultInstance: Lfosine_default_bar_audio_offset_scalar_trig_scalar = new Lfosine_default_bar_audio_offset_scalar_trig_scalar()
  ...
  reset(): void {
    this.copyFrom(Lfosine_default_bar_audio_offset_scalar_trig_scalar.defaultInstance)
  }

  copyFrom(src: Lfosine_default_bar_audio_offset_scalar_trig_scalar): void {
    this.phase = src.phase
    this.lastTrig = src.lastTrig
    this.lastSamplesPerBeat = src.lastSamplesPerBeat
    this.lastSamplesPerBar = src.lastSamplesPerBar
...
export class Lfosine_default_bar_audio_offset_scalar_trig_audio {
  static readonly defaultInstance: Lfosine_default_bar_audio_offset_scalar_trig_audio = new Lfosine_default_bar_audio_offset_scalar_trig_audio()

  phase: f32 = 0
  prevTrig: f32

  reset(): void {
    this.copyFrom(Lfosine_default_bar_audio_offset_scalar_trig_audio.defaultInstance)
  }

  copyFrom(src: Lfosine_default_bar_audio_offset_scalar_trig_audio): void {
    this.phase = src.phase
    this.prevTrig = src.prevTrig
  }
...
export class Lfosine_default_bar_audio_offset_audio_trig_scalar {
  static readonly defaultInstance: Lfosine_default_bar_audio_offset_audio_trig_scalar = new Lfosine_default_bar_audio_offset_audio_trig_scalar()
  ...
  reset(): void {
    this.copyFrom(Lfosine_default_bar_audio_offset_audio_trig_scalar.defaultInstance)
  }

  copyFrom(src: Lfosine_default_bar_audio_offset_audio_trig_scalar): void {
    this.phase = src.phase
    this.lastTrig = src.lastTrig
    this.lastSamplesPerBeat = src.lastSamplesPerBeat
    this.lastSamplesPerBar = src.lastSamplesPerBar
...
export class Lfosine_default_bar_audio_offset_audio_trig_audio {
  static readonly defaultInstance: Lfosine_default_bar_audio_offset_audio_trig_audio = new Lfosine_default_bar_audio_offset_audio_trig_audio()
  ...
  reset(): void {
    this.copyFrom(Lfosine_default_bar_audio_offset_audio_trig_audio.defaultInstance)
  }

  copyFrom(src: Lfosine_default_bar_audio_offset_audio_trig_audio): void {
    this.phase = src.phase
    this.lastSamplesPerBeat = src.lastSamplesPerBeat
    this.lastSamplesPerBar = src.lastSamplesPerBar
    this.prevTrig = src.prevTrig
