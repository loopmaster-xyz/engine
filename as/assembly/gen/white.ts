...
export class White_default_seed_scalar_trig_scalar {
  static readonly defaultInstance: White_default_seed_scalar_trig_scalar = new White_default_seed_scalar_trig_scalar()
  ...
  reset(): void {
    this.copyFrom(White_default_seed_scalar_trig_scalar.defaultInstance)
  }

  copyFrom(src: White_default_seed_scalar_trig_scalar): void {
...
export class White_default_seed_scalar_trig_audio {
  static readonly defaultInstance: White_default_seed_scalar_trig_audio = new White_default_seed_scalar_trig_audio()
  ...
  reset(): void {
    this.copyFrom(White_default_seed_scalar_trig_audio.defaultInstance)
  }

  copyFrom(src: White_default_seed_scalar_trig_audio): void {
    this.state = src.state
    this.prevTrig = src.prevTrig
    this.lastSeed = src.lastSeed
  }
